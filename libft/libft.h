...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/22 21:09:25 by kmurch            #+#    #+#             */
/*   Updated: 2019/04/25 17:14:37 by kmurch           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*ft_memccpy(void *destptr, const
		void *srcptr, int ch, size_t num);
...
int					ft_strosub(char **s, int start, int len);
char				*ft_strjoin(char const *s1, char const *s2);
char				*ft_strjoinlen(char const *s1, int size1,
		char const *s2, int size2);
int					ft_strojoin(char **s1, char const *s2);
int					ft_strojoinlen(char **s1, int size1,
		char const *s2, int size2);
